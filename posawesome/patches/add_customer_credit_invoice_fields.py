...
# Adapted from upstream c988133c + 7d74d02e (final placements): print/report
# fields persisting how much customer credit a sale redeemed and what balance
# remained. Read-only, set server-side by _apply_customer_credit_print_fields
# on the submit path; the closing-shift overview aggregates them for the corte.
FIELDS_BY_DOCTYPE = {
    "Sales Invoice": [
        {
