...
// Every `mdi-*` token under frontend/src AND under the saldo app's Vue
// sources (the `@saldo` vite alias — those components compile into this
// bundle and resolve icons through this same set), plus every Vuetify alias
// target (dropdown chevrons, checkboxes, sort arrows), resolved to its
// Material Design Icons path. `tests/mdiIconCoverage.spec.ts` re-derives the same inventory and
...
export const mdiIconPaths: Record<string, string> = {
	...
	"mdi-account-multiple-plus-outline": mdiAccountMultiplePlusOutline,
	...
	"mdi-cellphone-wireless": mdiCellphoneWireless,
	...
	"mdi-sync": mdiSync,
	"mdi-table": mdiTable,
	"mdi-table-furniture": mdiTableFurniture,
