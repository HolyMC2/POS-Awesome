...
| `08b5d170`+`118c8246` | print by server-assigned name in immediate print branch | **PICKED 2026-07-11** (both, upstream order 118c8246→08b5d170). Departures: kept our `trigger_print=1` main-URL contract (their =0 belongs to their pipeline); spec rewritten against our window.open flow + kept their offline-preview + name-guard cases; awaited `openOfflineInvoicePreview` (was fire-and-forget — their new spec exposed it). |
